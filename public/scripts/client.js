...
$(document).ready(function () {
        ...
        <article>
          <header>
              <div class="picAndUsername">
                <i><img src="${tweet.user.avatars}" alt="Icon"></i>
          ...
          <footer>
              <time class="timeago" datetime="2023-07-19T12:34:56">${timeago.format(
                tweet.created_at
              )}</time>
  ...
  $(".new-tweet-form").submit(function (event) {
    ...
    if (tweetText.length > 140) {
      const $meg = $(
        "<h3>Character limit exceeded. Please shorten your message.</h3>"
      );
